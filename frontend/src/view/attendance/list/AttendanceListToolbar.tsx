...
const AttendanceToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    attendanceSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    attendanceSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="attendance-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="attendance-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="attendance-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="attendance-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=attendance">
