const en = {
  ...
  entities: {
    employee: {
      ...
      label: 'Employees',
      menu: 'Employees',
      exporterFileName: 'Employees_export',
      list: {
        menu: 'Employees',
        title: 'Employees',
      },
      ...
      destroyAll: {
        success: 'Employee(s) successfully deleted',
      },
      edit: {
        title: 'Edit Employee',
      },
    ...
    leave: {
      ...
      label: 'Leaves',
      menu: 'Leaves',
      exporterFileName: 'Leaves_export',
      list: {
        menu: 'Leaves',
        title: 'Leaves',
      },
      create: {
        success: 'Leave successfully saved',
      },
      update: {
        success: 'Leave successfully saved',
      },
      ...
      destroyAll: {
        success: 'Leave(s) successfully deleted',
      },
      edit: {
        title: 'Edit Leave',
      },
    ...
    attendance: {
      ...
      label: 'Attendances',
      menu: 'Attendances',
      exporterFileName: 'Attendances_export',
      list: {
        menu: 'Attendances',
        title: 'Attendances',
      },
